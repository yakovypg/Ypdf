...
internal sealed class CompressImagesSubcommand
{
    ...
    internal const string ImageQualityFactorLongName = "quality";
    internal const string ImageSizeFactorLongName = "size";
    ...
    [ValueOption<float>(
        defaultValue: 0.75f,
        longName: ImageQualityFactorLongName,
        shortName: "q",
    ...
    internal float ImageQualityFactor { get; set; }

    [ValueOption<float>(
        defaultValue: 1.0f,
        longName: ImageSizeFactorLongName,
        shortName: "s",
    ...
    internal float ImageSizeFactor { get; set; }
